...
$packageArgs = @{
    ...
    fileType       = 'exe'
    url64          = 'https://github.com/nomic-ai/gpt4all/releases/download/v3.2.0/gpt4all-installer-win64-v3.2.0.exe'
    checksum64     = '6f58c26ca6eaa88c9f41e3be32d363d8e3e1af50ce5ac8c15a36132d2d3c5e7f'
